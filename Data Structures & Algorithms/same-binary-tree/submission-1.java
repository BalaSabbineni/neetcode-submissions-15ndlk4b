...
class Solution {
    public boolean isSameTree(TreeNode p, TreeNode q) {
        ...
        while(!queue.isEmpty()) {
            ...
            // Important edge case
            // we need continue this check, becuase 
            // if any one child is null and another is there, we need to check that
            // example: p and q's root.left is null, but right is not null and value is different.
            //so, we need to continuw.
