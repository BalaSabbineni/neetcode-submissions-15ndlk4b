...
// [0, n-1, 1, n-2, 2, n-3, ...]
    ...
    private void merge(ListNode l1, ListNode l2) {
        ...
        while (l1 != null) {
            ...
            // here add l1 element after l2
            l2.next = l1_next; // In the above we updated l1.next to l2, so we need to update l2_next as l1 element which is l1_next
